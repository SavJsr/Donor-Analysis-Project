...
float_cols = ['ant_copay_amount','ant_amt_attr_prodsel','ant_patient_pay','ant_oop_amount_appld','ant_covrgap'
             ,'ant_amt_lics','ant_refill_number','ant_number_of_fills','ant_dispense_qty','ant_days_supply','ant_usual_customary'
             ,'ant_dispensing_fee','ant_oop_remain_amt','ant_incentive_paid','ant_total_sales_tax','ant_amt_excdn_benmax'
             ,'ant_amt_attr_salestx','ant_deductible_remng','ant_percentage_taxrt','ant_awp_unit_price','ant_troop','ant_gdca'
             ,'ant_full_awp','ant_hra']
